...
| Remote dispatch starter | File-based worker registry + task request contract selects an edge worker and records the decision reason |
...
| Remote Dispatch Starter | File-based worker registry and task request contract for selecting a remote edge worker without claiming production remote execution | [`docs/remote_dispatch_starter.md`](docs/remote_dispatch_starter.md) |
