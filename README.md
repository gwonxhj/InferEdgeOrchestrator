...
| Jetson TensorRT inference smoke | Built `models/identity_fp16.plan` from identity ONNX on Jetson and executed one TensorRT identity frame: `PASS_TENSORRT_INFERENCE` | `reports/jetson_tensorrt_guard_validation.md` |
