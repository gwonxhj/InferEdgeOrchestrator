...
| Jetson TensorRT contention smoke | TensorRT task 2개를 scheduler/load-shedding으로 실행하고 low-priority drop 및 TensorRT backend telemetry 검증 | PASS | [`docs/tensorrt_backend.ko.md`](tensorrt_backend.md) |
